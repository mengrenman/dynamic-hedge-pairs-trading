...
`pairs_trading_04_hyperparameter_tuning.ipynb`, `tv_cointegration_kalman.ipynb` and
`visualize_cointegrated_pairs.ipynb` are generated by the scripts in
...
│  └─ build/                               # scripts that generate nb04, the tv and the visualisation notebooks + execute.py runner
│
