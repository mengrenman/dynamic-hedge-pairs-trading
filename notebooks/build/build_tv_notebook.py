"""Build notebooks/tv_cointegration_kalman.ipynb (cells only; outputs are produced by execute.py).
...
parser = argparse.ArgumentParser(description="Build tv_cointegration_kalman.ipynb (cells only).")
parser.add_argument("--out", type=Path, default=NOTEBOOKS / "tv_cointegration_kalman.ipynb",
