...
50 bp/year borrow on the short leg, no market impact. Sharpe ratios are annualized with the number of bars
...
neighbors at 10 and 30 sessions sit at 0.6–1.3 and 0.9–1.2, and the half-life rule (a look-back that
varies by pair and fold around 22 sessions) gives 1.5. The whole positive region is within about one
standard error of the default, and a peak one row above its neighbors in a two-parameter grid evaluated
