"""Build notebooks/pairs_trading_06_daily_lake.ipynb (cells only; outputs are produced by execute.py).
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", type=Path, default=Path(__file__).resolve().parent.parent / "pairs_trading_06_daily_lake.ipynb")
    args = ap.parse_args()
