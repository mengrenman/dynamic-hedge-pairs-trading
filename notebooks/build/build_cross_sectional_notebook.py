...
in notebook 17, which is exactly what a bounce-driven signal would look like.
...
fewer than ten positions on average), the same pairs intraday (indistinguishable from zero, notebooks 17–19 — a
